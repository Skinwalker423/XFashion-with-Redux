...
export const CartDropdownProvider = ({children}) => {
    ...
    const setCartDropdownDisplayed = (isDisplayed) => {
        dispatch({type: ACTION_TYPES.SET_CARTDROPDOWN_DISPLAY, payload: isDisplayed} )
    }
    ...
    const updateCartItemsReducer = (newCartItems) => {
        ...
        dispatch({type: ACTION_TYPES.SET_CART_ITEMS, payload: { cartItems: newCartItems, totalQuanityInCart: totalQuantity, totalPrice: totals }})
